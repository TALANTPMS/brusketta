...
function showStartQuestions() {
    ...
    const questions = [
        'Интересует конкретная позиция',
        'Осуществляете ли доставку металлопродукции и ЖБИ?',
        'Можно узнать цены на металлопрокат и ЖБИ?',
        'Какие гарантии даете на продукцию и услуги?',
        'Есть ли дополнительные услуги: резка, окраска и так далее?',
